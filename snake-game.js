...
grd.addColorStop(0, "rgba(67, 217, 173, 100)");
grd.addColorStop(1, "rgba(67, 217, 173, 10)");
...
base_image.src = './styles/components/src/food.svg'
...
ctx.fillRect(0,0,canvas.clientWidth,canvas.clientHeight)// black color start from 0px left, right to canvas width and canvas height
 ...
 function drawApple(){
    ...
    //  ctx.fillRect(appleX*tileCount, appleY*tileCount, tileSize, tileSize)
        ctx.drawImage(base_image, appleX*tileSize, appleY*tileSize, 40, 40);
 }
